...
pub struct RiskManager {
    ...
    personality: std::sync::Arc<StoicPersonality>,
}

impl RiskManager {
    pub fn new(config: StrategyConfig, personality: std::sync::Arc<StoicPersonality>) -> Self {
        Self {
            config,
    ...
    fn assess_market_risk(&self, market: &MarketContext) -> f64 {
        let mut risk_score: f64 = 0.5; // Start neutral
