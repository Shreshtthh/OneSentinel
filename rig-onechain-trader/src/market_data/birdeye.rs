...
use crate::market_data::{
    ...
    SocialMetrics,
    EnhancedTokenMetadata as TokenMetadata,
};
...
impl DataProvider for BirdEyeProvider {
    ...
    async fn get_historical_prices(&self, address: &str, _timeframe: &str) -> Result<Vec<PricePoint>> {
        let url = format!(
    ...
    async fn get_feature_vector(&self, token_address: &str) -> Result<crate::market_data::FeatureVector> {
        Ok(crate::market_data::FeatureVector {
